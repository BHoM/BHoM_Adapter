...
namespace BH.Adapter
{
    public abstract partial class BHoMAdapter
    {
        ...
        protected bool ReplaceAndMerge<T>(List<T> objectsToPush, IEqualityComparer<T> comparer, List<Type> dependencies, string tag = "", bool applyMerge = true) where T : BHoMObject
        {
